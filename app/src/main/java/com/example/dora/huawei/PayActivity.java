...
public class PayActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    //appid
    private final static String mAppid = "101051449";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        output.setText("Starting Pay Demo");
    ...
    private void isBillingSupported() {
        output.setText("check if billing is supported for current device and country ");

        Task<IsBillingSupportedResult> task = Iap.getIapClient(PayActivity.this).isBillingSupported();
        task.addOnSuccessListener(new OnSuccessListener<IsBillingSupportedResult>() {
            ...
            public void onSuccess(IsBillingSupportedResult isBillingSupportedResult) {
                if (isBillingSupportedResult != null) {
                    output.append("isBillingSupported success: " + isBillingSupportedResult.getReturnCode());
            ...
            public void onFailure(Exception e) {
                if (e instanceof IapApiException) {
                    ...
                    if (status.getStatusCode() == OrderStatusCode.ORDER_HWID_NOT_LOGIN) {
                        output.append("user not login");
                        Log.i(TAG, "not login");
                        if (status.hasResolution()) {
                            try {
                                //If there is no login, please login  startResolutionForResult
                                status.startResolutionForResult(PayActivity.this, Constant.REQ_CODE_NOT_LOGIN);
                            } catch (IntentSender.SendIntentException exp) {
                            }
                        }
                    } else if (status.getStatusCode() == OrderStatusCode.ORDER_ACCOUNT_AREA_NOT_SUPPORTED) {
                        output.append("IAP is not currently supported at the service location");
    ...
    private void getPurchases(int priceType) {
        output.setText("Query all ordered goods information of user");
        ...
        Task<GetPurchasesResult> task = Iap.getIapClient(getApplication()).getPurchases(getPurchaseReq);
        task.addOnSuccessListener(new OnSuccessListener<GetPurchasesResult>() {
            ...
            public void onSuccess(GetPurchasesResult result) {
                ...
                if (result != null) {
                    ...
                    output.append("getPurchases onSuccess:" + result.getItemList().toString());
            ...
            public void onFailure(Exception e) {
                if (e instanceof IapApiException) {
                    ...
                    output.append("getPurchases fail code:" + statuscode);
    ...
    private void getSkuDetail(int priceType, ArrayList<String> skus) {
        output.setText("Query product details");
        ...
        Task<SkuDetailResult> task = Iap.getIapClient(this).getSkuDetail(skuDetailReq);
        task.addOnSuccessListener(new OnSuccessListener<SkuDetailResult>() {
            ...
            public void onSuccess(SkuDetailResult result) {
                ...
                if (result != null) {
                    ...
                    output.append("getSkuDetail success " + result.getReturnCode() + " skuDetail" + skuDetail.toString());
            ...
            public void onFailure(Exception e) {
                if (e instanceof IapApiException) {
                    ...
                    output.append("getSkuDetail fail：" + status.getStatusCode());
                    Log.i(TAG, "getSkuDetail fail：" + status.getStatusCode());
                    Log.i(TAG, "getSkuDetail fail：" + e.getMessage());
                }
            }
        });
    }
    ...
    private void getBuyIntentWithPrice() {
        output.setText("Buy product with Price");
        ...
        Task<GetBuyIntentResult> task = Iap.getIapClient(this).getBuyIntentWithPrice(getBuyIntentWithPriceReq);
        task.addOnSuccessListener(new OnSuccessListener<GetBuyIntentResult>() {
            ...
            public void onSuccess(GetBuyIntentResult result) {
                if (result != null) {
                    ...
                    output.append("getBuyIntentWithPrice" + status.getStatusCode() + status.getStatusMessage() + status.getErrorString());
                    ...
                    try {
                        ...
                        status.startResolutionForResult(PayActivity.this, Constant.REQ_CODE_GO_PAY);
            ...
            public void onFailure(Exception e) {
                if (e instanceof IapApiException) {
                    ...
                    if (status.getStatusCode() == OrderStatusCode.ORDER_HWID_NOT_LOGIN) {
                        ...
                        output.append("order item already owned");
                        Log.i(TAG, "order item already owned");
                    } else {
                        output.append("getBuyIntentWithPrice statuscode：" + status.getStatusCode());
    ...
    private void getPurchaseHistory(int priceType) {
        output.setText("Get Purchase History");
        GetPurchaseReq getPurchaseReq = new GetPurchaseReq();
        getPurchaseReq.priceType = priceType;
        if (!mContinuationToken.isEmpty()) {
            getPurchaseReq.continuationToken = mContinuationToken;
        }
        Task<GetPurchasesResult> task = Iap.getIapClient(this).getPurchaseHistory(getPurchaseReq);
        task.addOnSuccessListener(new OnSuccessListener<GetPurchasesResult>() {
            @Override
            public void onSuccess(GetPurchasesResult result) {
                //Get execution results
                if (result != null) {
                    output.append("getPurchaseHistory success " + result.getReturnCode());
    ...
    private void getBuyIntent(int priceType, String productId) {
        ...
        Task<GetBuyIntentResult> task = Iap.getIapClient(this).getBuyIntent(getBuyIntentReq);
        task.addOnSuccessListener(new OnSuccessListener<GetBuyIntentResult>() {
            @Override
            public void onSuccess(GetBuyIntentResult result) {
                ...
                if (result != null) {
                    Status status = result.getStatus();
                    output.append("getBuyIntent success" + status.getStatusCode() + " " + status.getStatusMessage());
            ...
            public void onFailure(Exception e) {
                if (e instanceof IapApiException) {
                    IapApiException iapApiException = (IapApiException) e;
                    Status status = iapApiException.getStatus();
                    output.append("getBuyIntent fail：" + status.getStatusCode());
    ...
    private void consumePurchase() {
        output.setText("Consume Comsumeable Product");
        ...
        Task<ConsumePurchaseResult> task = Iap.getIapClient(this).consumePurchase(consumePurchaseReq);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == Constant.REQ_CODE_NOT_LOGIN) {
            ...
            output.append("isBillingSupported: " + bundle.getInt("returnCode") + "");
            ...
            output.append("pay result: " + buyResultInfo.getReturnCode());
            ...
            if (buyResultInfo.getReturnCode() == 0) {
                ...
                try {
                    ...
                    output.append("order ID " + jsonObject.getString("orderId"));
